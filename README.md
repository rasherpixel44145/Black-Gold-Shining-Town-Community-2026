...
# 🎮 Black Gold - Shining Town — Community Edition

**Standalone Community Edition of the mining town simulation.**
...
Black Gold - Shining Town is a mining and town-management simulation in which players develop a settlement above rich mineral deposits, balancing extraction, trade, and expansion. This Community Edition is a standalone build of the complete game, distributed as a self-contained package. No storefront or additional software is required; the title is ready to play immediately after installation.

Intended for players seeking a standalone offline build of a mining and town-management simulation on Windows.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4228690/5c456de5a226999abad1a57485121807e7a998f7/ss_5c456de5a226999abad1a57485121807e7a998f7.1920x1080.jpg?t=1788176824" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4228690/df18daf6cfb010021a428a7ee13f46885db5cddc/ss_df18daf6cfb010021a428a7ee13f46885db5cddc.1920x1080.jpg?t=1788176824" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4228690/9c5d6d08bdee22b2ea58b5cc981cac97f5a15a9a/ss_9c5d6d08bdee22b2ea58b5cc981cac97f5a15a9a.1920x1080.jpg?t=1788176824" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, Simplified Chinese, Russian
- **Voiceover:** English
...
- ⛏️ **Mining Simulation** — Extract ore and minerals from layered deposits beneath the settlement.
- 🏘️ **Town Construction** — Build and upgrade residential, industrial, and commercial structures.
- 📈 **Economy Management** — Balance production, wages, and market prices to keep the town profitable.
- 🗺️ **Territory Expansion** — Extend operations across the surrounding map as surface resources deplete.
- 💾 **Self-Contained Package** — Includes all content in a single installation with no additional downloads.
- 🔌 **Fully Offline** — Runs offline on Windows with no storefront or account required.
...
| **Processor** | Intel Core i3-2100 or AMD equivalent, 2.1 GHz | Intel Core i5-8400 or AMD Ryzen 5 2600 |
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 650 or AMD Radeon HD 7750, 1 GB VRAM | NVIDIA GeForce GTX 1050 Ti or AMD Radeon RX 560 |
| **Storage** | 4 GB available space | 4 GB available space on SSD |
| **Additional** | DirectX 11 compatible system, keyboard and mouse | DirectX 12 compatible system, keyboard and mouse |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\BlackGold-ShiningTown\Saved`
